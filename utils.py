...
# Dataset directories.
DATASET_DIR = {
    CHALLENGE: './data/Challenge_Dataset'
}
...
PATH_PATTERN = {
    #1:  ((None, USER), (RECOMMENDED, ARTICLE), (RESPONSE, ARTICLE)),
    #11: ((None, USER), (RESPONSE, ARTICLE), (RESPONSE, USER),(RESPONSE,ARTICLE)),
    #12: ((None, USER), (RESPONSE, ARTICLE), (WITHIN, WORD), (WITHIN, ARTICLE)),
    #13: ((None, USER), (RESPONSE, ARTICLE), (HAS_TOPIC, TOPIC), (HAS_TOPIC, ARTICLE)),
    #14: ((None, USER), (RESPONSE, ARTICLE), (HAS_PRODUCT, PRODUCT), (HAS_PRODUCT, ARTICLE)),
    #15: ((None, USER), (RESPONSE, ARTICLE), (ALSO_RESPONSE, ARTICLE), (ALSO_RESPONSE, ARTICLE)),
    #16: ((None, USER), (RESPONSE, ARTICLE), (RESPONSE_TOGETHER, ARTICLE), (RESPONSE_TOGETHER, ARTICLE)),
    #17: ((None, USER), (RESPONSE, ARTICLE), (RECOMMENDED_TOGETHER, ARTICLE), (RECOMMENDED_TOGETHER, ARTICLE)),
    #18: ((None, USER), (RECOMMENDED, ARTICLE),(RECOMMENDED, USER),(RECOMMENDED, ARTICLE)),
    #19: ((None, USER), (RESPONSE, ARTICLE), (HAS_TOPIC_TAG, TOPIC_TAG),(HAS_TOPIC_TAG, ARTICLE)),
    #20: ((None, USER), (RESPONSE, ARTICLE), (HAS_PRODUCT_TAG, PRODUCT_TAG),(HAS_PRODUCT_TAG, ARTICLE)),
    
    #1:  ((None, USER), (RECOMMENDED, ARTICLE), (RESPONSE, ARTICLE)),
    11: ((None, USER), (RECOMMENDED, ARTICLE), (RECOMMENDED, USER),(RECOMMENDED,ARTICLE)),
    #12: ((None, USER), (RECOMMENDED, ARTICLE), (WITHIN, WORD), (WITHIN, ARTICLE)),
